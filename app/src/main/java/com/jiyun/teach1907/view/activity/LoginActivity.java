package com.jiyun.teach1907.view.activity;

import android.content.Intent;
import android.text.TextUtils;
import android.view.View;

import com.jiyun.teach1907.base.BaseMvpActivity;
import com.jiyun.teach1907.constants.JumpConstant;
import com.jiyun.teach1907.model.AccountModel;
...
import com.jiyun.teach1907.view.design.LoginView;
...
public class LoginActivity extends BaseMvpActivity<AccountModel> implements LoginView.LoginViewCallBack {
    ...
    private void jump() {
        if (mFromType.equals(JumpConstant.SPLASH_TO_LOGIN) || mFromType.equals(JumpConstant.SUB_TO_LOGIN))
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.close_login:
                if (!TextUtils.isEmpty(mFromType)&&(mFromType.equals(JumpConstant.SUB_TO_LOGIN) || mFromType.equals(JumpConstant.SPLASH_TO_LOGIN))){
                    startActivity(new Intent(this,HomeActivity.class));
                }
                finish();
                break;
