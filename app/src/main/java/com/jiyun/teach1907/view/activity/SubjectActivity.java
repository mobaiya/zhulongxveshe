...
import com.jiyun.teach1907.adapter.SubjectAdapter;
import com.jiyun.teach1907.model.LauchModel;
        ...
        moreContent.setOnClickListener(v->{
            ...
            if (mFrom.equals(JumpConstant.SPLASH_TO_SUB)){
                if (mApplication.isLogin()){
                    ...
                    startActivity(new Intent(SubjectActivity.this,LoginActivity.class).putExtra(JumpConstant.JUMP_KEY, JumpConstant.SUB_TO_LOGIN));
                }
            }
            finish();
        });
