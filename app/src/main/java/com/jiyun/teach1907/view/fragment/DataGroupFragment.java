package com.jiyun.teach1907.view.fragment;

import android.content.Intent;

import androidx.recyclerview.widget.RecyclerView;

import com.jiyun.teach1907.constants.JumpConstant;
...
import com.jiyun.teach1907.adapter.DataGroupAdapter;
import com.jiyun.teach1907.base.BaseMvpFragment;
import com.jiyun.teach1907.interfaces.DataListener;
import com.jiyun.teach1907.interfaces.OnRecyclerItemClick;
import com.jiyun.teach1907.model.DataModel;
import com.jiyun.teach1907.view.activity.LoginActivity;
...
import static com.jiyun.teach1907.adapter.DataGroupAdapter.FOCUS_TYPE;
import static com.jiyun.teach1907.adapter.DataGroupAdapter.ITEM_TYPE;
            ...
            switch ((int)pObjects[0]){
                ...
                case FOCUS_TYPE:
                    ...
                    if (login){
                        ...
                        startActivity(new Intent(getContext(), LoginActivity.class).putExtra(JumpConstant.JUMP_KEY, JumpConstant.DATAGROUPFRAGMENT_TO_LOGIN));
                    }
                    break;
            }
        }
